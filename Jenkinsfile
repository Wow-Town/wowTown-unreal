pipeline {
    ...
    stages {
        ...
        stage('Docker Image Build') {
            ...
            steps {
                echo 'Build Start!!!'
                sh 'docker build -t wowtown_metaverse:0.1 ./'
            }
        }
        stage('Docker Hub Push') {
            ...
            steps {
                ...
                sh 'docker image tag wowtown_metaverse:0.1 devconf5296/wowtown_metaverse:0.1'
                sh 'echo $dockerhub_PSW | docker login -u $dockerhub_USR --password-stdin'

                sh 'docker push devconf5296/wowtown_metaverse:0.1'
                sh 'docker rmi devconf5296/wowtown_metaverse:0.1'
